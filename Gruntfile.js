...
module.exports = function (grunt) {
                ...
                files: [
                    {
                        ...
                        dest: '<%= yeoman.dist %>',
                        src: [
                            '*.{ico,png,txt}', '.htaccess', '*.html', 'images/**', 'fonts/**', 'assets/**', 'effects/*', 'multimedia/*'
                        ]
                    },
                    {
                        expand: true,
    ...
    grunt.registerTask('serve', function (target) {
        ...
        grunt.task.run([
            'clean:server', //      'bowerInstall',
            'concurrent:server', 'autoprefixer', 'connect:livereload', 'watch'
        ]);
    });
    ...
    grunt.registerTask('build', [
        'clean:dist', //    'bowerInstall','
        'less', 'useminPrepare', 'concurrent:dist', 'autoprefixer', 'concat', //        'ngmin',
        'copy:dist', //    'cdnify',
        'cssmin', 'uglify', 'rev', 'usemin' , 'htmlmin:dist']);
