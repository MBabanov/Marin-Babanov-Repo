...
estars.directive('passwordStrength', function () {
    return {
        ...
        link: function (scope /*, elem, attrs*/) {
            var mesureStrength = function (p) {
                    ...
                    }, tmp, strength = 0, letters = 'abcdefghijklmnopqrstuvwxyz', numbers = '01234567890', symbols = '\\!@#$%&/()=?¿', back, forth, i;
