(function () {
    ...
    module = angular.module('topSlider.directives', []);
    ...
    module.directive('slicker', [
        '$timeout', '$templateCache', '$sce', function ($timeout, $templateCache) {
            var SLICK_FUNCTION_WHITELIST, SLICK_OPTION_WHITELIST, isEmpty;
            $templateCache.put('template.html', "<div class=\"multiple\" ng-repeat=\"m in media\" on-finish-render=\"init()\">\n  <img ng-if=\"isImage({media: m})\" ng-src=\"{{m.src}}\" />\n  <video ng-if=\"isVideo({media: m})\" ng-src=\"{{m.src}}\" type=\"{{m.mimeType}}\" duration=\"{{m.duration}}\" controls ></video>\n</div>");
            ...
            return {
                ...
                controller: function ($scope, $sce) {
                    ...
                    // when the controller load data from server take the duration of the video
                    // TO DO parser to take duration
                },
                link: function (scope, element, attr) {
